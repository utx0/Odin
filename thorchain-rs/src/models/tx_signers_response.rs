...
impl TxSignersResponse {
    pub fn new(tx: crate::models::ObservedTx, txs: Vec<crate::models::ObservedTx>, actions: Vec<crate::models::TxOutItem>, out_txs: Vec<crate::models::Tx>) -> TxSignersResponse {
        TxSignersResponse {
            tx_id: None,
            tx: Box::new(tx),
            txs,
