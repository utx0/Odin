...
pub struct QuoteSwapResponse {
    ...
    #[serde(rename = "streaming_slippage_bps")]
    pub streaming_slippage_bps: i64,
    ...
    #[serde(rename = "expected_amount_out_streaming")]
    pub expected_amount_out_streaming: String,
    /// the maxiumum amount of trades a streaming swap can do for a trade
    #[serde(rename = "max_streaming_quantity", skip_serializing_if = "Option::is_none")]
    pub max_streaming_quantity: Option<i64>,
    /// the number of blocks the streaming swap will execute over
    #[serde(rename = "streaming_swap_blocks", skip_serializing_if = "Option::is_none")]
    pub streaming_swap_blocks: Option<i64>,
    /// approx the number of seconds the streaming swap will execute over
    #[serde(rename = "streaming_swap_seconds", skip_serializing_if = "Option::is_none")]
    pub streaming_swap_seconds: Option<i64>,
    /// total number of seconds a swap is expected to take (inbound conf + streaming swap + outbound delay)
    #[serde(rename = "total_swap_seconds", skip_serializing_if = "Option::is_none")]
    pub total_swap_seconds: Option<i64>,
}

impl QuoteSwapResponse {
    pub fn new(outbound_delay_blocks: i64, outbound_delay_seconds: i64, fees: crate::models::QuoteFees, slippage_bps: i64, streaming_slippage_bps: i64, expiry: i64, warning: String, notes: String, expected_amount_out: String, expected_amount_out_streaming: String) -> QuoteSwapResponse {
        QuoteSwapResponse {
            ...
            streaming_swap_blocks: None,
            streaming_swap_seconds: None,
            total_swap_seconds: None,
        }
    }
}
